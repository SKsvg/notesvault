...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Explore NotesVault's powerful features including note uploading, browsing, Jotpad, and To-Do list"
    />
      ...
      <section class="features-grid-section">
        <div class="container">
          <div class="features-grid">
            ...
            <article class="feature-card" id="upload-feature">
              ...
              <div class="feature-content">
                <h2>Upload Notes</h2>
                <p>
                  Share your study materials with the community in just a few
            ...
            <article class="feature-card" id="browse-feature">
              <div class="feature-icon">
            ...
            <!-- Jotpad Feature -->
            <article class="feature-card" id="jotpad-feature">
              <div class="feature-icon">
              ...
              <div class="feature-content">
                <h2>Jotpad</h2>
                <p>
                  Quickly jot down ideas, formulas, or reminders without leaving
            ...
            <article class="feature-card" id="todo-feature">
              ...
              <div class="feature-content">
                <h2>To-Do List</h2>
                <p>
                  Organize your study schedule, assignment deadlines, revision
